...
latex_documents = [
    (
        master_doc,
        "expipe-plugin-cinpla.tex",
        "expipe-plugin-cinpla Documentation",
        "Mikkel E. Lepperoed, Alessio Buccino",
        "manual",
    ),
]
...
man_pages = [(master_doc, "expipe-plugin-cinpla", "expipe-plugin-cinpla Documentation", [author], 1)]
